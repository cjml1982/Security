...
#   define NDNBOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_OPEN namespace pkiboost_mpl_ {
...
namespace pkiboost { namespace mpl { using namespace NDNBOOST_MPL_AUX_ADL_BARRIER_NAMESPACE; 
...
#   define NDNBOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_OPEN namespace pkiboost { namespace mpl {
#   define NDNBOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE }}
#   define NDNBOOST_MPL_AUX_ADL_BARRIER_DECL(type) /**/
