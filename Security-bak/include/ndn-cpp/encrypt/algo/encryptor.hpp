...
/*modify by marty, 2017/07/06, add READY,REGISTER
*
*
*/
...
public:
  ...
  static const Name::Component&
  getNAME_COMPONENT_TO() { return getValues().NAME_COMPONENT_TO; }
  ...
  static const Name::Component&
  getNAME_COMPONENT_REGISTER() { return getValues().NAME_COMPONENT_REGISTER; }

  static const Name::Component&
  getNAME_COMPONENT_READY() { return getValues().NAME_COMPONENT_READY; }
...
private:
  ...
  public:
    ...
    : NAME_COMPONENT_FOR("FOR"),
      NAME_COMPONENT_TO("TO"),
      NAME_COMPONENT_READ("READ"),
      NAME_COMPONENT_SAMPLE("SAMPLE"),
      NAME_COMPONENT_REGISTER("REGISTER"),
      NAME_COMPONENT_READY("READY"),
    ...
    Name::Component NAME_COMPONENT_TO;
    Name::Component NAME_COMPONENT_READ;
    Name::Component NAME_COMPONENT_SAMPLE;
    Name::Component NAME_COMPONENT_REGISTER;
    Name::Component NAME_COMPONENT_READY;
