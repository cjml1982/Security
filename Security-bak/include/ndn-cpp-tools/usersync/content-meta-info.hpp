...
public:
   ...
   */
  ContentMetaInfo&
  setTimestamp(pki::MillisecondsSince1970 timestamp)
  {
   ...
   */
  void
  wireDecode(const pki::Blob& input)
  {
...
private:
  ...
  pki::MillisecondsSince1970 timestamp_;
  bool hasSegments_;
  pki::Blob other_;
};
