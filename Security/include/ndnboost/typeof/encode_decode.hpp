...
#   define NDNBOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace pkiboost_typeof {
#   define NDNBOOST_TYPEOF_END_ENCODE_NS }}
#   define NDNBOOST_TYPEOF_ENCODE_NS_QUALIFIER ndnboost_typeof

#else

#   define NDNBOOST_TYPEOF_BEGIN_ENCODE_NS namespace pkiboost { namespace type_of {
#   define NDNBOOST_TYPEOF_END_ENCODE_NS }}
...
namespace pkiboost { namespace type_of {
