...
namespace pki { namespace ptr_lib = ndnboost; }
#endif
...
namespace pki { namespace func_lib {
  using std::function;
  using std::mem_fn;
  using std::bind;
  using std::ref;
  ...
  // using namespace pki::func_lib::placeholders;
  namespace placeholders {}
} }
#elif NDN_CPP_HAVE_BOOST_FUNCTION && NDN_CPP_WITH_BOOST_FUNCTION
#include <boost/function.hpp>
#include <boost/bind.hpp>
namespace pki { namespace func_lib = boost; }
#else
...
namespace pki { namespace func_lib = ndnboost; }
#endif
